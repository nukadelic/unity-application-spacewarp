...
namespace UnityEngine.Rendering.Universal.Internal
{
    ...
    ///
    /// This will render objects that have a material and/or shader with the pass name "OculusMotionVectors".
    /// </summary>
    public class OculusMotionVectorPass : ScriptableRenderPass
    {
        ...
        RTHandle motionVectorColorIdentifier;
        RTHandle motionVectorDepthIdentifier;
        ...
        {
            this.motionVectorColorIdentifier = RTHandles.Alloc(motionVecColorIdentifier);
            this.motionVectorDepthIdentifier = RTHandles.Alloc(motionVecDepthIdentifier);
        }
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            //RasterCommandBuffer rcb = CommandBufferHelpers.GetRasterCommandBuffer(cmd);
            ...
            using (new ProfilingScope(cmd, m_ProfilingSampler))
            {
                ...
                var drawSettings = CreateDrawingSettings(
                    new ShaderTagId("OculusMotionVectors"), 
                    ref renderingData, 
