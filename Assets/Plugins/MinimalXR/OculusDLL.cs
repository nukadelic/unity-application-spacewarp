...
{ 
	...
	public static partial class OculusDLL
	{
        ...
        // Extracted from : Assets/Oculus/VR/Scripts/OVRCommon.cs
        public class OVRNativeBuffer : IDisposable { // Encapsulates an 8-byte-aligned of unmanaged memory.
			...
			public int GetCapacity() { return m_numBytes; }
			public IntPtr GetPointer(int byteOffset = 0) { if (byteOffset < 0 || byteOffset >= m_numBytes)
				return IntPtr.Zero;return (byteOffset == 0) ? m_ptr : new IntPtr(m_ptr.ToInt64() + byteOffset); }
			public void Dispose() { Dispose(true); GC.SuppressFinalize(this); }
			private void Dispose(bool disposing) { if (disposed) return; if (disposing) {} Release(); disposed = true; }
			private void Reallocate(int numBytes) { Release();
				if (numBytes > 0) { m_ptr = Marshal.AllocHGlobal(numBytes); m_numBytes = numBytes; } 
				else { m_ptr = IntPtr.Zero; m_numBytes = 0; } }
			private void Release() { if (m_ptr != IntPtr.Zero) { Marshal.FreeHGlobal(m_ptr); m_ptr = IntPtr.Zero; m_numBytes = 0; } }
		}
		...
		public static bool initialized
		{
			get {
				...
				return false;
	#else
				return OVRP_1_1_0.ovrp_GetInitialized() == OculusDLL.Bool.True;
	#endif
			}
		}
		...
		public static bool chromatic
		{
			get {
				...
				if (version >= OVRP_1_7_0.version)
					return initialized && OVRP_1_7_0.ovrp_GetAppChromaticCorrection() == OculusDLL.Bool.True;
		...
		public static bool monoscopic
		{
			get {
				...
				return false;
	#else
				return initialized && OVRP_1_1_0.ovrp_GetAppMonoscopic() == OculusDLL.Bool.True;
	#endif
			}
			set {
	#if OVRPLUGIN_UNSUPPORTED_PLATFORM
		...
		public static bool useIPDInPositionTracking
		{
			get {
				...
				if (initialized && version >= OVRP_1_6_0.version)
					return OVRP_1_6_0.ovrp_GetTrackingIPDEnabled() == OculusDLL.Bool.True;
		...
		public static bool deprecated_headphonesPresent
		{
			get {
	#if OVRPLUGIN_UNSUPPORTED_PLATFORM
				return false;
	#else
				return initialized && OVRP_1_3_0.ovrp_GetSystemHeadphonesPresent() == OculusDLL.Bool.True;
	#endif
			}
		}
	...
	#if !OVRPLUGIN_UNSUPPORTED_PLATFORM
		private static GUID _nativeAudioOutGuid = new OculusDLL.GUID();
			...
			get {
				...
				try
				{
					if (_nativeAudioOutGuid == null)
						_nativeAudioOutGuid = new OculusDLL.GUID();
	...
	#if !OVRPLUGIN_UNSUPPORTED_PLATFORM
		private static GUID _nativeAudioInGuid = new OculusDLL.GUID();
			...
			get {
				...
				try
				{
					if (_nativeAudioInGuid == null)
						_nativeAudioInGuid = new OculusDLL.GUID();
		...
		[System.Obsolete("Deprecated. This function will not be supported in OpenXR", false)]
		public static float deprecated_batteryTemperature
		{
			get {
	#if OVRPLUGIN_UNSUPPORTED_PLATFORM
				return 0.0f;
		...
		public static int cpuLevel
		{
			get {
				...
				return 0;
	#else
				return OVRP_1_1_0.deprecated_ovrp_GetSystemCpuLevel();
	#endif
			}
			set {
	#if OVRPLUGIN_UNSUPPORTED_PLATFORM
				return;
	#else
				OVRP_1_1_0.deprecated_ovrp_SetSystemCpuLevel(value);
	#endif
			}
		}
		...
		public static int gpuLevel
		{
			get {
				...
				return 0;
	#else
				return OVRP_1_1_0.deprecated_ovrp_GetSystemGpuLevel();
	#endif
			}
			set {
	#if OVRPLUGIN_UNSUPPORTED_PLATFORM
				return;
	#else
				OVRP_1_1_0.deprecated_ovrp_SetSystemGpuLevel(value);
	#endif
			}
		}
		...
		[System.Obsolete("Deprecated. This function will not be supported in OpenXR", false)]
		public static float deprecated_systemVolume
		{
			get {
	#if OVRPLUGIN_UNSUPPORTED_PLATFORM
				return 0.0f;
		...
		[System.Obsolete("Deprecated. This function will not be supported in OpenXR", false)]
		public static bool deprecated_ShowUI(PlatformUI ui)
		{
	#if OVRPLUGIN_UNSUPPORTED_PLATFORM
			return false;
	#else
		...
		public static bool GetBoundaryConfigured()
		{
			...
			if (version >= OVRP_1_8_0.version)
			{
				return OVRP_1_8_0.ovrp_GetBoundaryConfigured() == OculusDLL.Bool.True;
			}
			else
			{
				return false;
		...
		[System.Obsolete("Deprecated. This function will not be supported in OpenXR", false)]
		public static BoundaryTestResult deprecated_TestBoundaryNode(Node nodeId, BoundaryType boundaryType)
		{
	#if OVRPLUGIN_UNSUPPORTED_PLATFORM
			...
			if (version >= OVRP_1_8_0.version)
			{
				return OVRP_1_8_0.deprecated_ovrp_TestBoundaryNode(nodeId, boundaryType);
			}
			else
			{
				return new BoundaryTestResult();
		...
		[System.Obsolete("Deprecated. This function will not be supported in OpenXR", false)]
		public static BoundaryTestResult deprecated_TestBoundaryPoint(Vector3f point, BoundaryType boundaryType)
		{
	#if OVRPLUGIN_UNSUPPORTED_PLATFORM
			return new BoundaryTestResult();
	#else
			if (version >= OVRP_1_8_0.version)
			{
				return OVRP_1_8_0.deprecated_ovrp_TestBoundaryPoint(point, boundaryType);
			}
			else
			{
				return new BoundaryTestResult();
		...
		public static bool GetBoundaryGeometry2(BoundaryType boundaryType, IntPtr points, ref int pointsCount)
		{
			...
			{
				return OVRP_1_9_0.ovrp_GetBoundaryGeometry2(boundaryType, points, ref pointsCount) == OculusDLL.Bool.True;
			}
			else
			{
				pointsCount = 0;
		...
		public static bool ResetAppPerfStats()
		{
			...
			if (version >= OVRP_1_9_0.version)
			{
				return OVRP_1_9_0.ovrp_ResetAppPerfStats() == OculusDLL.Bool.True;
			}
			else
			{
				return false;
		...
		public static double GetHandNodePoseStateLatency()
		{
			...
			{
				double value = 0.0;
				if (OVRP_1_18_0.ovrp_GetHandNodePoseStateLatency(out value) == OculusDLL.Result.Success)
				{
					return value;
				}
				else
		...
		public static bool SetDesiredEyeTextureFormat(EyeTextureFormat value)
		{
			...
			if (version >= OVRP_1_11_0.version)
			{
				return OVRP_1_11_0.ovrp_SetDesiredEyeTextureFormat(value) == OculusDLL.Bool.True;
			}
			else
			{
				return false;
		...
		public static int GetExternalCameraCount()
		{
	...
	#endif
			{
				...
				if (result != OculusDLL.Result.Success)
				{
		...
		[System.Obsolete("Deprecated. This function will not be supported in OpenXR", false)]
		public static bool deprecated_GetBoundaryVisible()
		{
	#if OVRPLUGIN_UNSUPPORTED_PLATFORM
			return false;
	#else
			if (version >= OVRP_1_8_0.version)
			{
				return OVRP_1_8_0.deprecated_ovrp_GetBoundaryVisible() == OculusDLL.Bool.True;
			}
			else
			{
				return false;
		...
		[System.Obsolete("Deprecated. This function will not be supported in OpenXR", false)]
		public static bool deprecated_SetBoundaryVisible(bool value)
		{
	#if OVRPLUGIN_UNSUPPORTED_PLATFORM
			return false;
	#else
			if (version >= OVRP_1_8_0.version)
			{
				return OVRP_1_8_0.deprecated_ovrp_SetBoundaryVisible(ToBool(value)) == OculusDLL.Bool.True;
			}
			else
			{
				return false;
		...
		{
			return (b) ? OculusDLL.Bool.True : OculusDLL.Bool.False;
		}
		...
		[System.Obsolete("Deprecated. This function will not be supported in OpenXR", false)]
		public static float deprecated_GetAdaptiveGPUPerformanceScale()
		{
	#if OVRPLUGIN_UNSUPPORTED_PLATFORM
			return 1.0f;
	#else
	...
	// Virtual keyboard calls
		...
		public static OculusDLL.Result SaveSpaceList(NativeArray<ulong> spaces, SpaceStorageLocation location, out UInt64 requestId)
		{
			requestId = 0;
	#if OVRPLUGIN_UNSUPPORTED_PLATFORM
			return Result.Failure_Unsupported;
		...
		private static class OVRP_1_1_0
		{
			...
			[DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
			public static extern int deprecated_ovrp_GetSystemCpuLevel();

			[System.Obsolete("Deprecated. Replaced by ovrp_SetSuggestedCpuPerformanceLevel", false)]
			[DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
			public static extern Bool deprecated_ovrp_SetSystemCpuLevel(int value);

			[System.Obsolete("Deprecated. Replaced by ovrp_GetSuggestedGpuPerformanceLevel", false)]
			[DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
			public static extern int deprecated_ovrp_GetSystemGpuLevel();

			[System.Obsolete("Deprecated. Replaced by ovrp_SetSuggestedGpuPerformanceLevel", false)]
			[DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
			public static extern Bool deprecated_ovrp_SetSystemGpuLevel(int value);
		...
		private static class OVRP_1_8_0
		{
			...
			[System.Obsolete("Deprecated. This function will not be supported in OpenXR", false)]
			[DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
			public static extern BoundaryTestResult deprecated_ovrp_TestBoundaryNode(Node nodeId, BoundaryType boundaryType);

			[System.Obsolete("Deprecated. This function will not be supported in OpenXR", false)]
			[DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
			public static extern BoundaryTestResult deprecated_ovrp_TestBoundaryPoint(Vector3f point, BoundaryType boundaryType);
			...
			[System.Obsolete("Deprecated. This function will not be supported in OpenXR", false)]
			[DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
			public static extern Bool deprecated_ovrp_GetBoundaryVisible();

			[System.Obsolete("Deprecated. This function will not be supported in OpenXR", false)]
			[DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
			public static extern Bool deprecated_ovrp_SetBoundaryVisible(Bool value);
